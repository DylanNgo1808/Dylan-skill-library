...
- **Security work**: Identify actual attack surfaces vs. assumed security boundaries
- **Adversarial analysis**: Sharpen critique by deconstructing assumptions
- **When stuck**: Rebuild from fundamentals
- **Any task**: When inherited assumptions may be limiting the solution space
